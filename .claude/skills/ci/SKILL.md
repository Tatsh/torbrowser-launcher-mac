...
- **changelog** - update `CHANGELOG.md` with entries for the changes.
  ...
  files under `torbrowser_launcher_mac/`, or dependency/version changes.
  **Skip for**: workflows, CI config, `.claude/`,
...
For example, if a commit contains `torbrowser_launcher_mac/main`, and `CHANGELOG.md`, the component
is determined by
