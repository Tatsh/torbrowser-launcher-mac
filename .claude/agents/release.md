...
Prepares and publishes a new release for the torbrowser-launcher-mac project.
...
1. **Update GitHub release notes** using `gh` (authenticated for this repository). After the tag
   ...
   - **Full Changelog line:** After the body, append **one blank line**, then exactly:
     `**Full Changelog**: https://github.com/Tatsh/torbrowser-launcher-mac/compare/vPREV...vNEW` where
